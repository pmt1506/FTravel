...
const Users = () => {
  ...
  return (
    <DashboardTemplate title="Manage User" className="row">
      <Row className="m-3">Action Bar</Row>
            ...
            {user.map((currentUser, index) => (
              <tr key={currentUser._id}>
                ...
                <td style={{ fontSize: "0.8rem" }}>
                  {currentUser.accountRole?.roleName}
                </td>
                <td
                  style={{
                    fontSize: "0.8rem",
                    color: currentUser.status ? "green" : "red",
                    fontWeight: "bold",
                  }}
                >
                ...
                <td>
                  <Button
                    ...
                    onClick={() =>
                      handleStatusUpdate(currentUser._id, currentUser.status)
                    }
                  >
